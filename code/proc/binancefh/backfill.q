...
.binancefh.backfilltrades:{[symbol]
  ...
  resp:select sym:symbol,id,price,qty,tradetime:time,
    buyermaker:isBuyerMaker,fhtime:.z.p from resp;
...
{[sym]
  .timer.add[0D00:00:02;`.binancefh.backfilltrades;enlist sym;
    "Backfill for ",string sym]
  } each .binancefh.syms;
